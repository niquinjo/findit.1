...
//textSize(50);
  let c = color(255, 204, 0);
    fill(c);
  //image(imagemTempJogo, 50, 110, 400, 200);
...
function preload(){
  ...
  //imagemInstrucoesTemp= loadImage("temporaria_instru.jfif");
  //imagemTempJogo= loadImage("follow.gif");
  //imagemEngrenagem=loadImage("engrenagem.png");
  //imagemMob100=loadImage("mob100.jpg");
